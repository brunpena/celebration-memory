    ...
    <div className="space-y-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-0.5">{event.name} · {guests?.length ?? 0} participante(s)</p>
        </div>
      </div>
      ...
      {(!guests || guests.length === 0) ? (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-12 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">Os convidados aparecerão aqui quando enviarem fotos ou mensagens.</p>
        </div>
      ) : (
